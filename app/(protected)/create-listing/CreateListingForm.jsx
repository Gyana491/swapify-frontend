...
const CreateListingForm = () => {
  ...
  const handleCoverImageUpload = async (event) => {
    ...
    if (file) {
        ...
        formData.append('files', file);  // Changed from 'file' to 'files' to match the API expectation
        ...
        try {
            ...
            // Update to handle the response format that matches your additional images upload
            const filename = data.files[0].filename;
            setCoverImageName(filename);
            setCoverImage(`${process.env.NEXT_PUBLIC_MEDIACDN}/uploads/${filename}`); // Add this line
  ...
  const handleNextStep = () => {
    if (currentStep < STEPS.length - 1 && isStepComplete(currentStep)) {
      // Set category_id when moving from category step
      if (currentStep === 0) {
  ...
  return (
    <div className="container mx-auto px-4 py-4 max-w-5xl">
      ...
      <div className="mb-8 overflow-x-hidden">
        {/* <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
          <div className="mb-4 md:mb-0">
            <h2 className="text-lg md:text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
              {STEPS[currentStep].title}
            </h2>
            <p className="text-xs md:text-sm text-gray-500 mt-1">Step {currentStep + 1} of {STEPS.length}</p>
          </div>
          <div className="flex items-center gap-2 text-xs md:text-sm">
            <span className="text-gray-500">Progress</span>
            <div className="font-medium text-indigo-600">{Math.round(calculateProgress())}%</div>
          </div>
        </div> */}

        <div className="relative">
          {/* Connection Lines - Updated positioning */}
          <div className="absolute top-5 left-0 w-full h-[2px] bg-gray-200" />
          <div 
            className="absolute top-5 left-0 h-[2px] bg-gradient-to-r from-indigo-600 to-purple-600 transition-all duration-500"
          ...
          <div className="relative flex justify-between">
            {STEPS.map((step, index) => {
              ...
              <button
                    ...
                    `}
                  >
                    {/* Context Line - Updated for mobile */}
                    {isCurrent && (
                      <div className="absolute top-5 left-1/2 w-screen h-[2px] -translate-x-1/2 -z-10">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-indigo-100 to-transparent" />
                      </div>
                    )}

                    {/* Step Circle with Context Indicator */}
                    <div className={`
                    ...
                    `}>
                      {/* Step Icon/Number */}
                      {isCompleted ? (
                        <svg className="w-4 md:w-5 h-4 md:h-5 text-white relative z-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                        </svg>
                      ) : (
                        <div className={`relative z-20 ${isCurrent ? 'text-indigo-600' : 'text-gray-400'}`}>
                {step.icon}
                        </div>
                      )}
                      ...
                      {isCurrent && (
                        <>
                          ...
                          <div className="absolute inset-0 rounded-full bg-indigo-100 blur-sm opacity-40" />
                          
                          {/* Focus Ring */}
                          <div className="absolute -inset-1 rounded-full border-2 border-indigo-200" />
                          
                          {/* Active Indicator Dot */}
                          <div className="absolute -right-1 -top-1 w-2.5 h-2.5 rounded-full bg-indigo-600 z-20">
                            <div className="absolute inset-0 rounded-full bg-indigo-600 opacity-25 animate-pulse" />
                          </div>
                        </>
                      )}
                    </div>

                    {/* Step Label with Enhanced Current State */}
                    <div className={`
                    ...
                    `}>
                      <div className={`
                        ...
                        ${isCurrent 
                          ? 'text-indigo-600 transform scale-105' 
                          : isCompleted 
                            ? 'text-gray-900' 
                            : 'text-gray-400'
                        }
                ...
                {step.title}
                    ...
                    {isCompleted && index !== currentStep && (
                      ...
                      >
                        <div className="bg-gray-900 text-white text-[10px] md:text-xs py-1 px-2 rounded shadow-lg whitespace-nowrap">
                          Click to edit
                        </div>
      ...
      {/* Main Content */}
      <div className="bg-white rounded-xl shadow-lg dark:bg-gray-800 overflow-hidden transition-all duration-300">
        <div className="p-4 md:p-8">
          {/* Step Title with Animation */}
          <div className="mb-6 animate-fadeIn">
            <h2 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
              {STEPS[currentStep].title}
            </h2>
      ...
      <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                    {categories.map((category) => (
                      ...
                      >
                        ...
                        >
                          <span className="text-xs font-medium text-indigo-600">Select</span>
                          ...
                          <button
                            ...
                            className={`group relative overflow-hidden p-4 rounded-xl text-left transition-all duration-300 
                              ${selectedSubcategory === subcat
                                ? 'bg-gradient-to-br from-indigo-600 to-purple-600 shadow-lg shadow-indigo-500/20 scale-[1.02]'
                                : 'bg-white hover:bg-gradient-to-br hover:from-indigo-50 hover:to-purple-50 border border-gray-200 hover:border-transparent hover:shadow-md'
                              }`}
                          >
                            {/* Background Decoration */}
                            ...
                            <div className="relative">
                              ...
                              >
                                ...
                                <svg 
                                  className={`w-4 h-4 ${
                                    selectedSubcategory === subcat ? 'text-indigo-100' : 'text-indigo-600'
                                  }`} 
                                  fill="none" 
                                  stroke="currentColor" 
                                  viewBox="0 0 24 24"
                    ...
                    <div className="flex flex-col mb-3">
                      ...
                      <div className="relative group">
                        ...
                        >
                          ...
                          <div className="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 border border-dashed border-gray-300 hover:border-indigo-300 hover:from-indigo-50 hover:to-purple-50 transition-all duration-300">
                            <div className="aspect-[16/9] flex flex-col items-center justify-center p-8">
                              {/* Premium Upload Icon */}
                              <div className="relative mb-4">
                                <div className="w-20 h-20 rounded-2xl bg-white shadow-lg flex items-center justify-center transform -rotate-6 transition-transform group-hover:rotate-0">
                                  <svg className="w-10 h-10 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                  </svg>
                                </div>
                                <div className="absolute -right-3 -bottom-3 w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center">
                              ...
                              <div className="text-center space-y-2">
                                <h3 className="text-lg font-semibold text-gray-900">Upload Cover Image</h3>
            ...
            />
                  ...
                  {/* Right Column - Additional Images */}
                      ...
                      <div className="flex justify-between items-center mb-3">
                        <div>
                          <p className="text-sm font-medium text-gray-900 mb-0.5">Additional Images</p>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 mb-6">
            ...
            <input
              ...
              onChange={(e) => setTitle(e.target.value)}
                        className="w-full px-3 py-2 md:px-4 md:py-2 text-sm md:text-base rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 p-3 
                          ...
                          border border-gray-300 rounded-lg text-left
                          focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent 
                          transition-all duration-200 group"
                      >
                        <div className="relative flex-shrink-0 w-10 h-10 bg-indigo-50 rounded-lg flex items-center justify-center group-hover:bg-indigo-100 transition-colors">
                          <IoLocationSharp 
                            className={`h-5 w-5 ${
                              selectedLocation.display_name 
                                ? 'text-indigo-600' 
            ...
            />
                  ...
                  <div className="mt-4 p-3 bg-indigo-50 rounded-lg border border-indigo-100">
                    <h4 className="text-xs font-medium text-indigo-700 mb-2 flex items-center gap-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2 text-[11px] text-indigo-600">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="relative">
                      ...
                      <label 
                        ...
                        className="block p-4 bg-white border-2 border-indigo-600 rounded-xl cursor-pointer
                          transition-all duration-200
                          peer-checked:border-indigo-600 peer-checked:bg-gradient-to-r peer-checked:from-indigo-50 peer-checked:to-purple-50"
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="text-base font-medium text-gray-900">Free Listing</h3>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute -top-2 -right-2 z-20">
                        <span className="px-3 py-1 text-xs font-medium text-indigo-600 bg-indigo-50 rounded-full shadow-sm">
                          Coming Soon
                        </span>
                      </div>

                      {/* Premium Card */}
                      <div className="p-5 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border-2 border-indigo-100 rounded-xl relative overflow-hidden">
                        {/* Header */}
                        <div className="flex items-start justify-between mb-6">
                          <div>
                            <h3 className="text-base font-semibold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
                              Premium Listing
                            </h3>
                          </div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-900">Featured placement in search results</span>
                          </li>
                          ...
                          <li className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-900">Detailed performance analytics</span>
                          </li>
                          ...
                          <li className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-900">Priority customer support</span>
                          </li>
                        </ul>

                        {/* Decorative Elements */}
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-600/5 to-purple-600/5 rounded-full -mr-16 -mt-16" />
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-purple-600/5 to-pink-600/5 rounded-full -ml-16 -mb-16" />
                      </div>

                      {/* Overlay */}
                      <div className="absolute inset-0 bg-white/40 backdrop-blur-[1px] rounded-xl cursor-not-allowed" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky bottom-0 left-0 right-0 z-50 mt-8 pb-4 md:pb-0">
              <div className="px-4 py-3 bg-white border-t border-gray-200 shadow-lg md:shadow-none md:border-0 md:bg-transparent">
      ...
      <div className="mt-6 p-3 bg-white rounded-lg shadow-sm border border-gray-100">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[11px] text-gray-500">Auto-saving draft</span>
        </div>
          <button
            type="button"
            onClick={() => {
            ...
            className="text-[11px] text-red-500 hover:text-red-600 flex items-center space-x-1 px-2 py-0.5 rounded-md hover:bg-red-50/50"
          >
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
