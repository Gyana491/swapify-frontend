      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="space-y-6 order-2 lg:order-1">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 hover:shadow-md transition-shadow duration-200">
            ...
            {/* Title */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Product Title *</label>
              <input
                type="text"
                value={title}
                onChange={(e) => setTitle(e.target.value)}
                className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${errors.title ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none placeholder-gray-400 dark:placeholder-gray-500`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3.5 rounded-xl border-2 transition-all duration-200 text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${errors.price ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none placeholder-gray-400 dark:placeholder-gray-500`}
                      placeholder="0"
                      min="1"
                      inputMode="numeric"
                    />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 appearance-none text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${errors.category ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none`}
                  >
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Subcategory *</label>
                <div className="relative">
                  <select
                    value={subcategory}
                    onChange={(e) => setSubcategory(e.target.value)}
                    disabled={!category}
                    className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 appearance-none text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:cursor-not-allowed ${errors.subcategory ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none`}
                  >
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 resize-none text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${errors.description ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none placeholder-gray-400 dark:placeholder-gray-500`}
            ...
            {/* Contact Number */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Contact Number *</label>
              <input
                type="tel"
                value={phoneNumber}
                onChange={(e) => setPhoneNumber(e.target.value)}
                className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${errors.phoneNumber ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none placeholder-gray-400 dark:placeholder-gray-500`}
            ...
            <div>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 p-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border-2 rounded-xl text-left transition-all duration-200 min-h-[56px] ${errors.location ? 'border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-500' : 'border-gray-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-200 dark:focus:border-indigo-400'} focus:ring-4 focus:outline-none`}
              >
        ...
        <div className="space-y-6 order-1 lg:order-2">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 hover:shadow-md transition-shadow duration-200">
            ...
            {/* Cover Image */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-3">Cover Image *</label>
              <div className="relative">
                {coverImage ? (
                  <div className="relative group">
                    <img src={coverImage} alt="Cover preview" className="w-full h-64 sm:h-72 object-cover rounded-xl border-2 border-gray-200 dark:border-gray-700" />
            ...
            {/* Additional Images */}
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-3">Additional Images ({additionalImages.length}/{MAX_ADDITIONAL_IMAGES})</label>
              <div className="grid grid-cols-3 gap-3 mb-4">
                {additionalImages.map((image, index) => (
                  <div key={index} className="relative group aspect-square">
                    <img src={image} alt={`Additional ${index + 1}`} className="w-full h-full object-cover rounded-lg border-2 border-gray-200 dark:border-gray-700" />
