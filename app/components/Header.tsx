    ...
    <nav className=" bg-white drop-shadow-lg shadow-1 border-gray-200 py-2.5 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <Link href="/" className="flex items-center">
          <div className="w-full h-full flex items-center gap-2 bg-white rounded-lg overflow-hidden dark:bg-gray-900">
            <div className="rounded-md flex items-center">
              <Image src="/assets/Swapify.jpg" alt="Logo" width={40} height={40} className="rounded-md" />
            </div>
            <div className="text-black text-[32px]  font-bold underline leading-none dark:text-white ml-1">Swapify</div>
          </div>
        </Link>
