          ...
          <div className="px-8 py-10">
            <div className="flex flex-col items-center space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Login to access your Swapify account
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Link href="/auth/forgot-password" className="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
                      Forgot password?
                    </Link>
                  </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <Link href="/auth/register" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium">
                    Sign up
                  </Link>
                </p>
              </div>
